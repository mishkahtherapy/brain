...
func (r *SessionRepository) CreateSession(tx ports.SQLTx, session *domain.Session) error {
	// Validate required fields
	if session.ID == "" {
		return ErrSessionIDIsRequired
	}
	if session.RegularBookingID == "" && session.AdhocBookingID == "" {
